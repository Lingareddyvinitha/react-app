...
// import Sample from './components/DragAndDrop/Sample'
               ...
               <Router basename={process.env.PUBLIC_URL}>
                  <div>
                     <Switch>
                        ...
                        <Route
                           path='/mobx-todo-app'
                           children={<MobxTodoApp />}
                        />
                        <Route
                           exact
                           path='/mobx-store-todo-app'
                           children={<TodoApp />}
                        />
                        ...
                        <Route
                           path='/grid-game'
                           children={<GridMemoryGame />}
                        />
                        <Route path='/users-page' component={UsersPage} />
                        <Route
                           path='/todo-page'
                           component={TodoAppWithService}
                        />
                        <Route path='/login-page' component={LoginPage} />
                        <ProtectedRoutes
                           exact
                           path='/products-page'
                           component={ProductsPageRoute}
                        />
                        <Route
